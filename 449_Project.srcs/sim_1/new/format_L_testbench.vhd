...
EX_MEM: entity work.EX_MEM port map(clk, rst, Y, ID_EX_mem_out, ID_EX_wb_out, ID_EX_inst_out, A, B, EX_MEM_mem_addra, EX_MEM_mem_addrb, EX_MEM_DATA, EX_MEM_mem_en, EX_MEM_wr_en, EX_MEM_wb_out, EX_MEM_inst_out, EX_MEM_alu_result_out);
RAM: entity work.RAM port map(clk, rst, rst, EX_MEM_mem_en, EX_MEM_mem_en, EX_MEM_wr_en, EX_MEM_mem_addra, EX_MEM_mem_addrb, EX_MEM_DATA, RAM_data_outa, RAM_data_outb);
MEM_WB: entity work.MEM_WB port map(clk, rst, RAM_DATA_outb, EX_MEM_alu_result_out, old_PC, EX_MEM_inst_out, EX_MEM_wb_out, MEM_WB_wr_en, MEM_WB_data_out, MEM_WB_ra);
